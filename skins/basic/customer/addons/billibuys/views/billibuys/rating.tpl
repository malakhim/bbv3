...
{if $unrated.products && $unrated.user_ids}
	<form name="bb_rating_form" action="{"billibuys.rating"|fn_url}" method="post" enctype="multipart/form-data">
		...
		<div class="buttons-container">
			{include file="buttons/button.tpl" but_text=$lang.submit but_name="dispatch[billibuys.rating]" but_id="but_submit_ratings" }
		</div>
	</form>
...
{capture name="mainbox_title"}{$lang.ratings}{/capture}
