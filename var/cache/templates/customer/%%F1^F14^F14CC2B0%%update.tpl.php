...
<?php
fn_preload_lang_vars(array('image_verification_label','image_verification_body','register_new_account','contact_information','text_multiprofile_notice','billing_address','shipping_address','shipping_address','billing_address','image_verification_label','image_verification_body','usergroup','status','action','active','remove','available','join','declined','join','pending','cancel','profile_details'));
?>
<?php 
