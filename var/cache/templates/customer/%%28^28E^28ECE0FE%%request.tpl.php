<?php /* Smarty version 2.6.18, created on 2014-06-11 19:25:32
         compiled from addons/billibuys/views/billibuys/request.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'addons/billibuys/views/billibuys/request.tpl', 1, false),array('modifier', 'ucwords', 'addons/billibuys/views/billibuys/request.tpl', 21, false),array('modifier', 'default', 'addons/billibuys/views/billibuys/request.tpl', 87, false),array('modifier', 'unescape', 'addons/billibuys/views/billibuys/request.tpl', 120, false),array('modifier', 'fn_generate_thumbnail', 'addons/billibuys/views/billibuys/request.tpl', 120, false),array('modifier', 'escape', 'addons/billibuys/views/billibuys/request.tpl', 120, false),array('modifier', 'fn_convert_relative_to_absolute_image_url', 'addons/billibuys/views/billibuys/request.tpl', 123, false),array('modifier', 'replace', 'addons/billibuys/views/billibuys/request.tpl', 275, false),array('function', 'math', 'addons/billibuys/views/billibuys/request.tpl', 38, false),array('function', 'cycle', 'addons/billibuys/views/billibuys/request.tpl', 249, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('no_max_price','view_larger_image','item','price','name','quantity','total_price','delete','no_data','place_bid','delete','auction_finished','click_here_to_return_to_main_page'));
?>
<?php  ob_start();  ?><?php 
...
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('image_width' => '100', 'image_height' => '100', 'images' => $this->_tpl_vars['request']['image'], 'show_thumbnail' => 'N', 'no_ids' => true, 'class' => "request-list-image", )); ?>
