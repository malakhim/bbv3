...
<?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
		...
		<div id="requested_qty">
			<?php echo fn_get_lang_var('desired_amount', $this->getLanguage()); ?>
...
<?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?> [<?php echo $this->_tpl_vars['num_offers']; ?>
 <?php echo fn_get_lang_var('offers', $this->getLanguage()); ?>
]</div>
		<br/><br/>
