...
<?php
fn_preload_lang_vars(array('view_larger_image','max_price','no_max_price','time_remaining','ends','place_bid','auction_finished','click_here_to_return_to_main_page','prev_page','next','prev_page','next'));
?>
<?php 
...
" id="place-offer"><?php echo fn_get_lang_var('place_bid', $this->getLanguage()); ?>
</a>
					<?php else: ?>
