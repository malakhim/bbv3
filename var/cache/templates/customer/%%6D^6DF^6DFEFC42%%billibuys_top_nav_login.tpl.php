<?php /* Smarty version 2.6.18, created on 2014-10-24 23:11:42
...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'C:/wamp5/www/public_html/skins/basic/customer/addons/billibuys/blocks/static_templates/billibuys_top_nav_login.tpl', 2, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('my_account','sign_in','register','sign_in'));
?>
<?php if ($_SESSION['auth']['user_id']): ?>
	<span class="flat-btn"><a href="<?php echo fn_url('profiles.update'); ?>
"><?php echo fn_get_lang_var('my_account', $this->getLanguage()); ?>
</a></span>
	<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "blocks\my_account.tpl", 'smarty_include_vars' => array()));
