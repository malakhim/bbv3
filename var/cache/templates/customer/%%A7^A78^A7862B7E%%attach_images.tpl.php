<?php /* Smarty version 2.6.18, created on 2014-11-17 22:33:18
         compiled from ../admin/common_templates/attach_images.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'defined', '../admin/common_templates/attach_images.tpl', 24, false),array('modifier', 'define', '../admin/common_templates/attach_images.tpl', 25, false),array('modifier', 'explode', '../admin/common_templates/attach_images.tpl', 48, false),array('modifier', 'default', '../admin/common_templates/attach_images.tpl', 49, false),array('modifier', 'fn_url', '../admin/common_templates/attach_images.tpl', 70, false),array('modifier', 'unescape', '../admin/common_templates/attach_images.tpl', 173, false),array('modifier', 'fn_generate_thumbnail', '../admin/common_templates/attach_images.tpl', 173, false),array('modifier', 'escape', '../admin/common_templates/attach_images.tpl', 173, false),array('modifier', 'fn_convert_relative_to_absolute_image_url', '../admin/common_templates/attach_images.tpl', 176, false),array('modifier', 'cat', '../admin/common_templates/attach_images.tpl', 318, false),array('modifier', 'md5', '../admin/common_templates/attach_images.tpl', 318, false),array('modifier', 'trim', '../admin/common_templates/attach_images.tpl', 351, false),array('modifier', 'count', '../admin/common_templates/attach_images.tpl', 352, false),array('block', 'hook', '../admin/common_templates/attach_images.tpl', 66, false),array('function', 'math', '../admin/common_templates/attach_images.tpl', 91, false),array('function', 'script', '../admin/common_templates/attach_images.tpl', 315, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('delete_image_pair','thumbnail','view_larger_image','delete_image','upload_another_file','local','local','remove_this_item','remove_this_item','remove_this_item','remove_this_item','text_select_file','upload_another_file','local','server','url','alt_text','popup_larger_image','view_larger_image','delete_image','upload_another_file','local','local','remove_this_item','remove_this_item','remove_this_item','remove_this_item','text_select_file','upload_another_file','local','server','url','alt_text'));
?>
<?php 
  ...
  '../admin/common_templates/fileuploader.tpl' => 1406444267,
))) {
...
" class="cm-confirm cm-ajax delete cm-delete-image-link" name="delete_image"><?php echo fn_get_lang_var('delete_image', $this->getLanguage()); ?>
		...
		<div class="attach-images-alt">
			<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('var_name' => ($this->_tpl_vars['name'])."_image_icon".($this->_tpl_vars['suffix'])."[".($this->_tpl_vars['key'])."]", 'image' => true, )); ?><?php 
				...
				if ($this->compile_check && empty($inline_no_check[$rname]) && $this->is_cached($rname)) {
					if ($this->check_inline_blocks(array (
  'addons/product_configurator/hooks/fileuploader/uploaded_files.post.tpl' => 1406444269,
))) {
						$_smarty_compile_path = $this->_get_compile_path($rname);
						$this->_compile_resource($rname, $_smarty_compile_path);
						$inline_no_check[$rname] = true;
