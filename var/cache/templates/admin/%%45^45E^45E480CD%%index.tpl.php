<?php /* Smarty version 2.6.18, created on 2014-12-02 15:20:36
...
<?php 
  ...
  'common_templates/comet.tpl' => 1406444267,
))) {
...
/addons/twigmo/styles.css" rel="stylesheet" type="text/css" /><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?><?php endif; ?><?php if ($this->_tpl_vars['addons']['billibuys']['status'] == 'A'): ?><?php $__parent_tpl_vars = $this->_tpl_vars; ?><?php if (strpos($this->_tpl_vars['config']['current_url'], $this->_tpl_vars['config']['admin_index']) === false): ?>
...
/lib/js/jquery/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/skins/basic/customer/css/960/reset.css">

	<link rel="stylesheet" type="text/css" href="/skins/basic/customer/base.css">

	<link rel="stylesheet" type="text/css" href="/skins/basic/customer/css/960/960.css">
...
<?php $__parent_tpl_vars = $this->_tpl_vars; ?><?php 
				...
				if ($this->compile_check && empty($inline_no_check[$rname]) && $this->is_cached($rname)) {
					if ($this->check_inline_blocks(array (
  'addons/recurring_billing/hooks/index/scripts.post.tpl' => 1406444267,
))) {
						$_smarty_compile_path = $this->_get_compile_path($rname);
						$this->_compile_resource($rname, $_smarty_compile_path);
						$inline_no_check[$rname] = true;
