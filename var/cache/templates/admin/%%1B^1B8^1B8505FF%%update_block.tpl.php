...
<?php if ($this->_tpl_vars['is_twigmo_location']): ?>
	<div class="form-field">
		<label for="block_<?php echo $this->_tpl_vars['html_id']; ?>
_hide_header"><?php echo fn_get_lang_var('twgadmin_hide_header', $this->getLanguage()); ?>
:</label>
		<input type="hidden" name="block_data[properties][hide_header]" value="N">
		<input type="checkbox" class="checkbox" name="block_data[properties][hide_header]" value="Y" id="block_<?php echo $this->_tpl_vars['html_id']; ?>
_hide_header" <?php if ($this->_tpl_vars['block']['properties']['hide_header'] && $this->_tpl_vars['block']['properties']['hide_header'] == 'Y'): ?>checked="checked"<?php endif; ?> >
	</div>
