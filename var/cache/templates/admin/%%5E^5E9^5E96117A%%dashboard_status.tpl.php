<?php /* Smarty version 2.6.18, created on 2014-12-05 13:03:47
         compiled from addons/discussion/views/index/components/dashboard_status.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_get_predefined_statuses', 'addons/discussion/views/index/components/dashboard_status.tpl', 1, false),array('modifier', 'date_format', 'addons/discussion/views/index/components/dashboard_status.tpl', 16, false),array('modifier', 'default', 'addons/discussion/views/index/components/dashboard_status.tpl', 32, false),array('modifier', 'lower', 'addons/discussion/views/index/components/dashboard_status.tpl', 35, false),array('modifier', 'is_array', 'addons/discussion/views/index/components/dashboard_status.tpl', 39, false),array('modifier', 'fn_from_json', 'addons/discussion/views/index/components/dashboard_status.tpl', 40, false),array('modifier', 'fn_url', 'addons/discussion/views/index/components/dashboard_status.tpl', 72, false),array('modifier', 'trim', 'addons/discussion/views/index/components/dashboard_status.tpl', 110, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('active','hidden','disabled','pending','new','active','disabled','hidden','pending','new','active','disabled','hidden','pending','notify_customer','notify_orders_department','notify_vendor','notify_supplier'));
?>
<?php  ob_start();  ?><?php 
  ...
  'common_templates/select_popup.tpl' => 1406444267,
))) {
...
">
	<span class="float-left"><?php echo smarty_modifier_date_format($this->_tpl_vars['post']['timestamp'], ($this->_tpl_vars['settings']['Appearance']['date_format']).", ".($this->_tpl_vars['settings']['Appearance']['time_format'])); ?>
 &nbsp;-&nbsp;</span>
	<div class="float-left"><?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('id' => $this->_tpl_vars['post']['post_id'], 'status' => $this->_tpl_vars['post']['status'], 'hidden' => "", 'object_id_name' => 'post_id', 'table' => 'discussion_posts', 'items_status' => fn_get_predefined_statuses('discussion'), )); ?><?php if ($this->_tpl_vars['display'] == 'text'): ?>
