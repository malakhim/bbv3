<?php /* Smarty version 2.6.18, created on 2014-11-19 13:55:37
         compiled from file:C:%5Cwamp3%5Cwww%5Cpublic_html%5Clib%5Csmarty%5Cdebug.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign_debug_info', 'file:C:\\wamp3\\www\\public_html\\lib\\smarty\\debug.tpl', 3, false),array('function', 'cycle', 'file:C:\\wamp3\\www\\public_html\\lib\\smarty\\debug.tpl', 119, false),array('modifier', 'escape', 'file:C:\\wamp3\\www\\public_html\\lib\\smarty\\debug.tpl', 102, false),array('modifier', 'string_format', 'file:C:\\wamp3\\www\\public_html\\lib\\smarty\\debug.tpl', 105, false),array('modifier', 'debug_print_var', 'file:C:\\wamp3\\www\\public_html\\lib\\smarty\\debug.tpl', 121, false),)), $this); ?>
<?php  ob_start();  ?><?php echo smarty_function_assign_debug_info(array(), $this);?>
...
?>&nbsp;&nbsp;&nbsp;<?php endfor; endif; ?>
    <font color=<?php if ($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['type'] == 'template'): ?>brown<?php elseif ($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['type'] == 'insert'): ?>black<?php else: ?>green<?php endif; ?>>
        <?php echo smarty_modifier_escape($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['filename'], 'html'); ?>
</font>
    <?php if (isset ( $this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['exec_time'] )): ?>
        <span class="exectime">
        (<?php echo smarty_modifier_string_format($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['exec_time'], "%.5f"); ?>
)
...
">
            <th>{$<?php echo smarty_modifier_escape($this->_tpl_vars['_debug_keys'][$this->_sections['vars']['index']], 'html'); ?>
}</th>
...
?>
        <tr class="<?php echo smarty_function_cycle(array('values' => "odd,even"), $this);?>
">
            <th>{#<?php echo smarty_modifier_escape($this->_tpl_vars['_debug_config_keys'][$this->_sections['config_vars']['index']], 'html'); ?>
#}</th>
...
// <![CDATA[
    ...
    _smarty_console.document.write('<?php echo smarty_modifier_escape($this->_tpl_vars['debug_output'], 'javascript'); ?>
');
